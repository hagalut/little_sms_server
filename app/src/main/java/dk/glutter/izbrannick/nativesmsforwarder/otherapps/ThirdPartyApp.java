package dk.glutter.izbrannick.nativesmsforwarder.otherapps;
...
public class ThirdPartyApp {
    ...
    public boolean startApp(Context context, String packageName)
    {
        try {
            ...
            Log.d("lunching" + packageName + "  ", e.getMessage());
            return false;
        }
        return true;
    }
    ...
    {
        try {
            Log.d("SMSBackupPlus ", actionName);
            ...
            Log.d("lunching" + actionName + "  ", e.getMessage());
            return false;
        }
        return true;
    }
